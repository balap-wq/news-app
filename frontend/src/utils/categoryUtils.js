...
export const normalizeCategory = (val) => val.charAt(0).toUpperCase() + val.slice(1).toLowerCase();
...
// ── Toggle category
export const getNextCategory = (activeCategory, cat) => (activeCategory === cat ? '' : cat);
