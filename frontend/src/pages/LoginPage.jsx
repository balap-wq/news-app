...
const LoginPage = () => {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      ...
      {/* Modal card */}
      <div className="bg-[#161616] border border-white/10 rounded-3xl px-8 py-10 max-w-sm w-full mx-4 text-center shadow-2xl
                      animate-[popIn_0.4s_cubic-bezier(0.34,1.56,0.64,1)_both]">
        <NavLink to="/headlines"><span className="text-white"><ArrowLeft/></span></NavLink>
        ...
        >
          <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
            <path d="M17.64 9.205c0-.639-.057-1.252-.164-1.841H9v3.481h4.844a4.14 4.14 0 0 1-1.796 2.716v2.259h2.908C16.658 14.07 17.64 11.763 17.64 9.205z" fill="#4285F4"/>
        ...
        <p className="text-gray-300 text-[11px] text-center mt-7 leading-relaxed">
          ...
          <a href="#" className="text-orange-400 underline underline-offset-2 hover:text-white/60 transition-colors">Terms</a>
          {' '}and{' '}
          <a href="#" className="text-orange-400 underline underline-offset-2 hover:text-white/60 transition-colors">Privacy Policy</a>.
        </p>
      </div>
